...
for date_s in list_shopping_date:
    ...
    df_compra_date_fam['q_real_div_estimate'] = np.abs(df_compra_date_fam['q_real'] / df_compra_date_fam['q_estimate'] - 1)
    df_compra_date_fam.loc[(df_compra_date_fam['q_estimate'] == 0) & (df_compra_date_fam['q_real'] == 0), 'q_real_div_estimate'] = 0
    df_compra_date_fam.loc[(df_compra_date_fam['q_estimate'] == 0) & (df_compra_date_fam['q_real'] != 0), 'q_real_div_estimate'] = 1
    df_compra_date_fam.loc[(df_compra_date_fam['q_estimate'] != 0) & (df_compra_date_fam['q_real'] == 0), 'q_real_div_estimate'] = 1
...
df_envios = df_envios.groupby(['family_desc', 'size']).agg({'q_estimates_alg': 'sum',
